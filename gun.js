		...
		;(function(exports){ // On event emitter generic javascript utility.
			...
			On.create = function(){
				var on = function(e){
					...
					return {
						emit: on.emit.bind(this, e),
						event: on.event.bind(this, e)
					};
				};
				on.emit = function(n, a){
					var e = n, s = on.event.s[e], args = [], l = args.length;
				...
				on.event = function(n, fn, i){
					var s = on.event.s[n]; if(!s){ return }
